...
\titlespacing*{\subsection}{0pc}{1.5ex \@plus2pt \@minus1pt}{1pt}
...
$if(equal-contribution)$
    {\Affilfont * These authors contributed equally\par}
$endif$
...
\noindent\ifbfabstract\Affilfont\bfseries\else\footnotesize\fi  \faEnvelope\ Correspondence:\itshape}
